...
<head>
    <meta charset="UTF-8">
    <title> Accueil - IREKIA Day Care Service </title>
...
<section>
    ...
    <header>
        <h1 class="title"><a href ="./">Accueil - IREKIA Day Care Service</a></h1>
    </header>
</section>
<section>
    <nav>
...
<section>
<article>
    <h3>Bienvenue au service de garderie IREKIA !</h3>
    <p>Si vous n'avez pas de compte, allez dans le menu Registre pour vous inscrire.<br>
        Si vous avez un compte et que vous souhaitez accéder aux différents services, veuillez vous connecter.<br>
        Si vous souhaitez changer votre mot de passe, accédez au menu de changement de mot de passe.</p>
</article>
</section>
<br>
<br>
