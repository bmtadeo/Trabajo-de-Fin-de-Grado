...
<section>
    <nav>
        <ul>
            ...
            <li style="float:right"><a class ="active" href="ayuda.php"> مساعدة</a></li>
        </ul>
    </nav>
</section>
<section>
    <article>
        <h3>كيف تعمل خدمة الرعاية النهارية في IREKIA؟</h3>
            <p>إذا لم يكن لديك حساب ، فانتقل إلى قائمة التسجيل للتسجيل.<br>
                إذا كان لديك حساب وتريد الوصول إلى الخدمات المختلفة ، يرجى تسجيل الدخول.<br>
                إذا كنت ترغب في تغيير كلمة المرور الخاصة بك ، قم بالوصول إلى قائمة تغيير كلمة المرور.<p>
    </article>
</section>
<br>
<br>
