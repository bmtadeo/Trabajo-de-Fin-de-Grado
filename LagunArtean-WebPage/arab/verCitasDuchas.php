...
<head>
    <meta charset="UTF-8">
    <title>انظر أراك في الحمام</title>
...
<section>
    <nav>
        <ul>
            ...
            <li><a class="active"href="verCitasDuchas.php">انظر أراك في الحمام</a></li>
...
<section>
    ...
    if(isset($_SESSION["usu_id"])){
        if ($result->num_rows > 0) {
            echo "<p><b>مواعيد الاستحمام:</b></p>";
            echo "<table id='citasDucha'><tr><th>تاريخ</th><th>نضح</th><th>حالة الاستحمام</th><th>ساعة</th></tr>";
