...
$sql = "SELECT fecha, count(fecha) FROM InfoCafe group by fecha;";
...
<head>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var options = {
                title: "Numero de usuarios que usan el cafe por dia",
                width: 1080,
                height: 400,
                bar: {groupWidth: "80%"},
        ...
        <ul>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a class = "active" href="usoCafePorDía.php">Uso del servicio del café</a>
                </div>
            </li>
