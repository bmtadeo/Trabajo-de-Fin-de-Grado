...
<section>
    <form id="elegirDia" name="elegirDia" method="post" onsubmit="return obtenerDia()" action="reservarCitaLavanderia.php">
        <div class="container">
            <br>
            <br>
            <label ><b>Elige una fecha para la entrega de la ropa</b></label>
            <br>
            <label ><b>La ropa estará lista para su recogida al de dos dias</b></label>
            <br>
            <label ><b>También, podrás ver si esta lista en el menú de Ver Citas Lavanderia</b></label>
            <br>
            <br>
