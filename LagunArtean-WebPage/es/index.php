...
<head>
    <meta charset="UTF-8">
    <title>Inicio - Servicio de Atención Diurna IREKIA</title>
...
<section>
    ...
    <nav>
        <ul>
            ...
            <li><a href="../arab/index.php">العربي</a></li>
        </ul>
    </nav>
    <header>
        <h1 class="title"><a href ="./">Inicio - Servicio de Atención Diurna IREKIA</a></h1>
    </header>
</section>
<section>
    <nav>
...
<section>
<article>
    <h3>¡Bienvenido/a al servicio de atencion diurna IREKIA!</h3>
    <p>Si no tienes cuenta, accede al menu Registrar para registrarte.<br>
        Si tienes cuenta y quieres acceder a los diferentes servicios, inicia sesión.<br>
        Si quieres cambiar tu contraseña, accede al menu cambiar contraseña.</p>
</article>
</section>
<br>
<br>
