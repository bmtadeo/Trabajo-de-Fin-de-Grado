...
if($_SESSION["usu_id"]=="admin"){
    $sql = "SELECT fecha, count(fecha) FROM InfoLavanderia group by fecha;";
...
<head>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var options = {
                title: "Numero de usuarios que usan la lavanderia por dia",
                width: 1080,
                height: 400,
                bar: {groupWidth: "80%"},
        ...
        <ul>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a class = "active" href="usoLavanderiaPorDia.php">Uso de la lavandería</a>
